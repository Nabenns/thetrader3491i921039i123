...
<div class="glass-card p-4 rounded-xl group relative cursor-pointer" @click="$dispatch('open-trade-modal', { id: {{ $journal->id }} }); tradeModalOpen = true">
    ...
    <div class="mt-3 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <button class="p-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition-colors" onclick="openShareModal({{ $journal->id }}); event.stopPropagation();">
