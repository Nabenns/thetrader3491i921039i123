    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-8">
                ...
                <form action="{{ route('journal.destroy', $journal) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this trade?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="text-red-400 hover:text-red-300 text-sm flex items-center gap-1 bg-red-500/10 px-4 py-2 rounded-lg hover:bg-red-500/20 transition-colors">
                        ...
                        <div class="glass p-6 rounded-2xl border border-white/10">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1">
                                        ...
                                        <x-text-input id="pair" name="pair" type="text" class="pl-10 block w-full uppercase" 
                                            placeholder="e.g. XAUUSD" required x-model="pair" @input="detectPipValue" />
                                    </div>
                                ...
                                <div>
                                    ...
                                    <select id="status" name="status" class="mt-1 block w-full border-gray-700 bg-gray-900 text-gray-300 focus:border-primary focus:ring-primary rounded-xl shadow-sm" x-model="status">
                        ...
                        <div class="glass p-6 rounded-2xl border border-white/10">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="open_date" name="open_date" type="datetime-local" class="mt-1 block w-full" :value="old('open_date', $journal->open_date->format('Y-m-d\TH:i'))" required />
                                </div>
                                <div>
                                    <x-input-label for="close_date" value="Close Date" />
                                    <x-text-input id="close_date" name="close_date" type="datetime-local" class="mt-1 block w-full" :value="old('close_date', $journal->close_date ? $journal->close_date->format('Y-m-d\TH:i') : '')" />
                                </div>

                                <!-- Emotion -->
                                <div>
                                    <x-input-label for="emotion" value="Emotion / Psychology" />
                                    <select id="emotion" name="emotion" class="mt-1 block w-full border-gray-700 bg-gray-900 text-gray-300 focus:border-primary focus:ring-primary rounded-xl shadow-sm" x-model="emotion">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="strategy" name="strategy" type="text" class="mt-1 block w-full" :value="old('strategy', $journal->strategy)" />
                                </div>

                                <!-- Notes -->
                                <div>
                                    <x-input-label for="notes" value="Notes / Analysis" />
                                    <textarea id="notes" name="notes" rows="4" class="mt-1 block w-full border-gray-700 bg-gray-900 text-gray-300 focus:border-primary focus:ring-primary rounded-xl shadow-sm">{{ old('notes', $journal->notes) }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    @if($journal->screenshot)
                                        <div class="mb-4">
                                            <img src="{{ Storage::url($journal->screenshot) }}" alt="Trade Screenshot" class="rounded-lg w-full border border-white/10">
                                        </div>
                                    @endif
